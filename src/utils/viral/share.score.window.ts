...
export class ShareScoreWindow {
	...
	constructor() {
		...
		this.panel = this.game.add.sprite(28, 191,
			...
			ImageUtils.getAtlasClass('AtlasesVirals').Frames.ShareScorePanel,
			this.container
		);
		this.scoreText = this.game.add.bitmapText(
			this.game.world.centerX - 5, 460,
			ImageUtils.getBitmapFontClass('FontsFontBig').getName(),
			'0', 90, this.container);
		this.scoreText.anchor.setTo(0.5);
		this.label = this.game.add.sprite(28, 151,
			ImageUtils.getAtlasClass('AtlasesVirals').getName(),
		...
		this.vkBtn = GuiUtils.makeButton(this, this.container, 127, 684, 1, '',
			ImageUtils.getAtlasClass('AtlasesVirals').getName(),
		...
		this.fbBtn = GuiUtils.makeButton(this, this.container, 277, 689, 1, '',
			ImageUtils.getAtlasClass('AtlasesVirals').getName(),
